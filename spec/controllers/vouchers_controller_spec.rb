...
describe VouchersController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested voucher" do
        ...
        Voucher.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => voucher.id, :voucher => {'these' => 'params'}
      end

      it "assigns the requested voucher as @voucher" do
        voucher = Voucher.create! valid_attributes
        put :update, :id => voucher.id, :voucher => valid_attributes
        assigns(:voucher).should eq(voucher)
      end
    ...
    describe "with invalid params" do
      it "assigns the voucher as @voucher" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Voucher.any_instance.stub(:save).and_return(false)
        put :update, :id => voucher.id.to_s, :voucher => {}
        assigns(:voucher).should eq(voucher)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested voucher" do
      voucher = Voucher.create! valid_attributes
      expect {
        delete :destroy, :id => voucher.id.to_s
      }.to change(Voucher, :count).by(-1)
    end
